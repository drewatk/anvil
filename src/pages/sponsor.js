...
const EventsPage = ({ data, location }) => {
  const sections = [
    ...
    },
    {
      ...
      paragraphs: [
        <>
          We are always looking for support to keep building our community
          through events, outreach, and our coworking space. If you would like
          to sponsor The Anvil, you can refer to our{" "}
          <a
